        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Edytuj książkę</h2>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?php echo BASE_URL; ?>/ksiazki/edytuj/<?php echo $dane['ksiazka']->id; ?>" method="POST">
                        <div class="mb-3">
                            <label for="tytul" class="form-label">Tytuł</label>
                            <input type="text" class="form-control" id="tytul" name="tytul" 
                                   value="<?php echo $dane['ksiazka']->tytul; ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="autor" class="form-label">Autor</label>
                            <input type="text" class="form-control" id="autor" name="autor" 
                                   value="<?php echo $dane['ksiazka']->autor; ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="rok_wydania" name="rok_wydania" 
                                   value="<?php echo $dane['ksiazka']->rok_wydania; ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="isbn" name="isbn" 
                                   value="<?php echo $dane['ksiazka']->isbn; ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="ilosc_dostepnych" name="ilosc_dostepnych" 
                                   value="<?php echo $dane['ksiazka']->ilosc_dostepnych; ?>" min="0" required>
                        </div>
